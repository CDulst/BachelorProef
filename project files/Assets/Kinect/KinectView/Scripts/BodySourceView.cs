...
public class BodySourceView : MonoBehaviour
{
   ...
   //public GameObject meshInBetween;
    ...
    private void RefreshBodyObject(Kinect.Body body, GameObject bodyObject)
    {
        ...
        for (Kinect.JointType jt = Kinect.JointType.SpineBase; jt <= Kinect.JointType.ThumbRight; jt++)
        {
            ...
            if (jt.ToString().Equals("HandLeft"))
            {
                ...
                handLeft.transform.position = new Vector3(manoIzk.x+1/5, manoIzk.y-1/2, manoIzk.z);
                //print(manoIzk.x + "   " + manoIzk.y + "   " + manoIzk.z);      
                //CalculateVelocity(manoIzk, positionsHand);
                //print(velocity);
            ...
            if (jt.ToString().Equals("HandRight"))
            {
                ...
                handRight.transform.position = new Vector3(manoDer.x-1/2, manoDer.y-1/2, manoDer.z);
            ...
            {    
                ...
                kneeLeft.transform.position = new Vector3(rodillaIzk.x-1, rodillaIzk.y+1, rodillaIzk.z);
            ...
            if (jt.ToString().Equals("KneeRight"))
            {
                ...
                kneeRight.transform.position = new Vector3(rodillaDer.x+1, rodillaDer.y+1, rodillaDer.z);
            ...
            if (jt.ToString().Equals("Neck"))
            {
                ...
                head.transform.position = new Vector3(cabezaHead2.x, cabezaHead2.y-1, cabezaHead2.z);
                center2.transform.position = new Vector3(cabezaHead2.x, cabezaHead2.y-3, cabezaHead2.z);
            ...
            if (jt.ToString().Equals("SpineBase"))
            {
                ...
                center.transform.position = new Vector3(pelvisSpineBase.x, pelvisSpineBase.y+2, pelvisSpineBase.z);
